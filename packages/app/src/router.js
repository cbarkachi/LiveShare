...
const routes = [
  ...
  {
    path: `${SINGLE_POST_PAGE}/:user/:listingId`,
    component: Loadable({
      loader: () =>
        import(
  ...
  {
    path: `${BOOK_LISTING}/:user/:listingId/:dayIndex/:timeIndex`,
    component: Loadable({
      loader: () =>
        import(
          /* webpackChunkName: "SinglePageView" */ "./container/SinglePage/Reservation/BookListing"
        ),
      loading: Loading,
      modules: ["SinglePageView"],
    }),
  ...
  {
    path: `${AGENT_PROFILE_PAGE}/:userId`,
    component: Loadable({
      loader: () =>
        import(
...
const LoginPage = Loadable({
  loader: () =>
    import(/* webpackChunkName: "SignIn" */ "./container/Auth/SignIn/SignIn"),
  loading: Loading,
  modules: ["SignIn"],
});
  ...
  return (
    <Layout>
      <Switch>
        ...
        <ProtectedRoute path={ADD_SKILL_PAGE} component={AddListing} />
        <ProtectedRoute
